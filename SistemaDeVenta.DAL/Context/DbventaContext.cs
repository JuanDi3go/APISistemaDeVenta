...
namespace SistemaDeVenta.DAL.Context;
...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C21A19ADF");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F63EDD713");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483FFD279AC");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4F30089A3");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A9DA43F4B");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13246FCE780");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F7691A38A76");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6541BD93E");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561489CBF936");
